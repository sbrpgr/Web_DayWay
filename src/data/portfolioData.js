export const portfolioData = {
    strategy: {
        title: "Strategy",
        competency: "근거와 통찰을 바탕으로 한 기획력으로 복잡한 문제를 해결하고 승리를 쟁취합니다.",
        projects: [
            {
    ...
    rnd: {
        title: "R&D",
        competency: "혁신적 기획력과 기술력을 기반으로 다양한 프로젝트에서 산업의 표준을 만들어나갑니다.",
        projects: [
            {
    ...
    education: {
        title: "Education",
        competency: "R&D에서 축적된 AI 기술 노하우를 교육 콘텐츠로 확산합니다. 기업의 디지털 전환(DX)을 위한 실무 중심 교육을 제공합니다.",
        projects: [
            {
    ...
    platform: {
        ...
        competency: "AI 솔루션 유통 및 비즈니스 매칭 허브입니다. 공공 정책 제안부터 AI 에이전트 서비스까지 폭넓은 사업 모델을 운영합니다.",
        projects: [
            {
    ...
    design: {
        ...
        competency: "기술과 심미성의 결합을 통해 가치를 창출합니다.",
        projects: [
            {
